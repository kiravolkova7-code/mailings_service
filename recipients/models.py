...
class Recipients(models.Model):
    ...
    surname = models.CharField(max_length=40, verbose_name='Отчество', blank=True, null=True,
    ...
    comment = models.TextField(max_length=200, verbose_name='Комментарий', blank=True, null=True,
