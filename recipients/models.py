...
class Recipients(models.Model):
    ...
    surname = models.CharField(max_length=40, verbose_name='Отчество', blank=True, null=True, help_text='Укажите отчество (если есть)')
    last_name = models.CharField(max_length=40, verbose_name='Фамилия', help_text='Укажите фамилию')
    comment = models.TextField(max_length=200, verbose_name='Комментарий', blank=True, null=True, help_text='Ваш комментарий (необязательно)')
